...
2- مشکل بعدی این هست که ترمینال شما کلا فارسی رو ساپورت نمیکنه که خیلی کم پیش میاد مگر اینکه `emulator` شما یا قدیمی باشه و یا ترمنال خوبی نباشه که لیست ترمینال هایی که فارسی رو ساپورت میکنه رو مینویسم
...
**ویرایش دوم:اما به تازگی خبر دار شدم که vscode بر روی چیپ های آرم هم در حال توسعه هست که تنها روی سیستم [ویندوزی](https://code.visualstudio.com/updates/v1_47) الان در دسترس هست اما اگر نمونه اون رو بر روی آرم بخواهید تجربه کنید میتونید از [code-oss](https://code.headmelted.com/) استفاده کنید** 
 
قطعا در آینده نزدیک در مورد تبدیل کردن ی گوشی ساده به یک ابزار برنامه نویسی پیشرفته صحبت میکنم
...
خیلی ها حتی ادعا میکنند که کسی نتونسته تمام و کمال ویم رو یاد بگیره چون این ابزار زمان بسیار زیادی بین ما هست و توسعه اون تا الان انجام شده و به شدت گسترده شده
